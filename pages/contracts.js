  ...
  return (
    <div className="py-5">
      ...
      <p className="mb-4 font-bold">
        Below are the list of contracts this website use
      </p>
      <div>
        <p className="mb-4">
          {
            <a
              ...
              href={`https://etherscan.io/address/${poolContract.factoryContract.address}`}
              target="_blank"
            >
              NFT Pool Factory Contract: {poolContract.factoryContract.address}
            </a>
          }
        </p>
        <p className="mb-4">
          {
            <a
              className="hover:text-blue-500"
              href={`https://etherscan.io/address/${poolContract.swapContract.address}`}
              target="_blank"
            >
              NFT Swap Contract: {poolContract.swapContract.address}
            </a>
          }
        </p>
      </div>
              ...
              <div key={uuidv4()}>
                {
                  <a
                    ...
                    target="_blank"
                  >
                    [{i + 1}] {pool.name}: {pool.poolAddress}
                  </a>
                }
              </div>
            );
